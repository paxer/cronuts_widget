...
describe 'shared/_cronut_acceptance_widget.html.erb' do
  DEFAULT_CRONUTS_URL = /<a href="https:\/\/upload.wikimedia.org\/wikipedia\/commons\/8\/8b\/April_2016_Cronut%C2%AE_2_Burnt_Vanilla_Caramel_-_photo_by_Dominique_Ansel_Bakery.jpg" target="_blank">cronuts<\/a>/
  DEFAULT_DONUTS_URL = /<a href="https:\/\/upload.wikimedia.org\/wikipedia\/commons\/thumb\/a\/a5\/Glazed-Donut.jpg\/250px-Glazed-Donut.jpg" target="_blank">donuts<\/a>/
  ...
  it 'renders cronuts_url if passed instead of a default' do
    cronuts_url = /<a href="https:\/\/google.com" target="_blank">cronuts<\/a>/
  ...
  it 'renders donuts_url if passed instead of a default' do
    donuts_url = /<a href="https:\/\/yahoo.com" target="_blank">donuts<\/a>/
